...
def _main(args):
    ...
    validation_dataset, length_of_validation_dataset, _ = data_mgt.get_dataset(
        'valid')
    ...
    model_name = f'{model_name}_augmented_data.h5' if conf[
...
def main():
    ...
    argparser = argparse.ArgumentParser(
        description='Welcome to the Bushfires Detector training script')
